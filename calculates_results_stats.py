...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        label_match = results_dic[key][2] == 1
        if label_match:
        ...
        pet_image_label_is_a_dog = (results_dic[key][3] == 1)

        if label_match and pet_image_label_is_a_dog:
            results_stats_dic['n_correct_breed'] += 1

        if pet_image_label_is_a_dog:
            ...
            if classifier_classifies_image_as_dog:
        ...
        # Pet Image Label is NOT a Dog
            ...
            classifier_classifies_image_as_not_a_dog = results_dic[key][4] == 0
            if classifier_classifies_image_as_not_a_dog:
