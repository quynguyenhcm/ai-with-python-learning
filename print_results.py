...
def print_results(results_dic, results_stats_dic, model,
    ...
    if (print_incorrect_dogs and
        ...
        for key in results_dic:
            ...
            pet_image_lable_is_a_dog = results_dic[key][3] == 1
            classifier_classifies_image_as_dog = results_dic[key][4] == 1
            if pet_image_lable_is_a_dog and not classifier_classifies_image_as_dog:
                print('pet label is-a-dog and classifier label is-NOT-a-dog')
            if not pet_image_lable_is_a_dog and classifier_classifies_image_as_dog:
                print('pet label is-NOT-a-dog and classifier label is-a-dog')
